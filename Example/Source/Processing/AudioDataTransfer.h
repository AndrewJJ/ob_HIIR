...
public:
	...
	*	Observers/listeners should pre-allocate a member variable of ElementType to copy into if performance is critical. */
    ...
    {
        juce::WeakReference<AudioProbe<FrameType>> weakThis = this;
...
private:
    ...
    juce::HeapBlock <FrameType> writeQueue;

    typename juce::WeakReference<AudioProbe<FrameType>>::Master masterReference;
    friend class juce::WeakReference<AudioProbe<FrameType>>;
